...
public final class MusicUtils {
    ...
    public static void playArtist(final Context context, final long artistId, int position, boolean shuffle) {
        ...
        if (artistList != null) {
            playAll(artistList, position, artistId, shuffle);
        }
    }
     ...
     */
    public static void playAll(final long[] list, int position, final long sourceId,
     ...
     */
    public static void playNext(final long[] list, final long sourceId) {
        if (mService == null) {
            return;
        }
        try {
    ...
    public static void playAlbum(final Context context, final long albumId, int position, boolean shuffle) {
        ...
        if (albumList != null) {
            playAll(albumList, position, albumId, shuffle);
        }
    }
    ...
    public static final long[] getSongListForPlaylist(final Context context, final long playlistId) {
        Cursor cursor = null;//= PlaylistSongLoader.makePlaylistSongCursor(context, playlistId);
    ...
    public static void playPlaylist(final Context context, final long playlistId, boolean shuffle) {
        ...
        if (playlistList != null) {
            playAll(playlistList, -1, playlistId, shuffle);
        }
    }
